  ...
  return(
    <div className="relative h-screen">
      ...
      <div className="relative z-10 flex flex-col justify-center items-center h-full">
        <h1 className="text-4xl font-bold text-gray-800 mb-4">Bienvenue dans notre institut UNIVERS-TIC.</h1>
        <p className="text-lg text-gray-600 mb-4">Application web pour simplifier la gestion scolaire.</p>
